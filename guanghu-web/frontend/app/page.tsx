  ...
  return (
    <div className="space-y-10">
      <section className="text-center py-12">
        <h1 className="text-4xl font-bold text-gh-text mb-3">🌊 光湖 · GuangHu Lab</h1>
        <p className="text-gh-muted text-lg">人格体自主运行基础设施 · HLDP 驱动</p>
      </section>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gh-text mb-4">Agent 状态总览</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gh-text mb-4">最近工单</h2>
...
function StatCard({ label, value, color }: { label: string; value: number; color: 'blue' | 'yellow' | 'purple' | 'green' }) {
  const colorMap = {
