...
| 🏛️ **铸渊主权服务器** | 🆕 ZY-SVR-002 | **腾讯云 43.134.16.246** · 新加坡二区 · Ubuntu 24.04 · 铸渊100%主控 |
| ~~旧服务器~~ | ❌ **已弃用** | ~~150.109.76.244~~ (香港) / ~~8.155.62.235~~ (阿里云) · 已完全弃用 |
...
|------|------|
| 🏷️ 编号 | ZY-SVR-002 |
| 🌍 地址 | 43.134.16.246 (腾讯云 · 新加坡二区) |
| 💻 配置 | 2核 · 8GB · 80GB SSD · Ubuntu 24.04 LTS |
| 📡 状态 | Phase 1 · 落地 (等待冰朔配置密钥) |
| 🔗 部署 | `deploy-to-zhuyuan-server.yml` (ZY-WF-铸体) |
| ~~🗑️ 旧服务器~~ | ~~150.109.76.244 (香港) / 8.155.62.235 (阿里云·已弃用)~~ |
<!-- SERVER_STATUS_END -->
