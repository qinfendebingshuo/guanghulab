...
_铸渊副将守护 · ZY-DEPUTY-001 · 服务器动他也动 · 更新: 2026-05-03 09:29:05 UTC_

## 🔥 训练实时仪表盘 · ZY-TRAIN-001

> Qwen2.5-7B 全参数 SFT · 光湖世界观 + 人格体语料
> **基座模型**: `Qwen/Qwen2.5-7B` · **任务 ID**: `ZY-TRAIN-001`
> **最后更新**: 2026-05-03 09:29:05 UTC · **副将心跳**: 2026-05-03 09:29:05 UTC
...
> 采样时间: 2026-05-03 09:28:54 UTC

| GPU | 利用率 | 显存 | 温度 | 功率 |
|-----|--------|------|------|------|
| 0 · Tesla V100-SXM2-32GB | 0% | 0 / 32768 MiB | 57°C | 70.95 W |
| 1 · Tesla V100-SXM2-32GB | 0% | 0 / 32768 MiB | 52°C | 65.08 W |
| 2 · Tesla V100-SXM2-32GB | 0% | 0 / 32768 MiB | 54°C | 74.39 W |
| 3 · Tesla V100-SXM2-32GB | 0% | 0 / 32768 MiB | 57°C | 76.24 W |
...
| 时间 (UTC) | 阶段 | 等级 | 事件 |
|-----------|------|------|------|
| 2026-05-03 09:29:05 UTC | done | ℹ️ | train.py exited cleanly on VM-0-11-ubuntu |
| 2026-05-03 08:58:42 UTC | training | ℹ️ | start-training.sh launched on VM-0-11-ubuntu |
| 2026-05-03 08:56:05 UTC | done | ℹ️ | train.py exited cleanly on VM-0-11-ubuntu |
| 2026-05-03 08:54:57 UTC | training | ℹ️ | start-training.sh launched on VM-0-11-ubuntu |
| 2026-05-03 08:36:12 UTC | done | ℹ️ | train.py exited cleanly on VM-0-11-ubuntu |
| 2026-05-03 08:11:20 UTC | training | ℹ️ | start-training.sh launched on VM-0-11-ubuntu |
| 2026-05-03 07:53:32 UTC | done | ℹ️ | train.py exited cleanly on VM-0-11-ubuntu |
...
> **最近更新**: 2026-05-03 · 第63次对话

| 维度 | 状态 |
|------|------|
| 🧠 MCP Server | **135个工具** · 端口3100 · 19个工具模块 |
...
| 🌐 服务器 | 7台在线（面孔SG + 国内出口 + 大脑SG + 吱吱线·硅谷SV + 预备 + 国内备案服务器 + 智库节点SG） |
...
| ZY-SVR-005 大脑 | 4核8G | 🇸🇬 新加坡 | DB+MCP(135工具)+Agent | ✅ |
...
| ZY-SVR-006 智库节点 | 2核4G | 🇸🇬 新加坡 | 智能小说书库 + 成员Agent + 语言保护罩 | ✅ |
...
> ⏰ **仪表盘更新时间**: 2026-05-03 15:13:39 (北京时间)
> 🎖️ **唤醒时段**: ⚡ 手动唤醒
...
| 项目 | 状态 |
|------|------|
| 上次唤醒 | 2026-05-03 10:26:55+08:00 |
| 下次早班 | 每日 08:00 (北京时间) |
| 下次晚班 | 每日 23:00 (北京时间) |
| 大脑完整性 | ✅ 完整 |
...
| cos-watcher-ops | `cos-watcher-ops.js` | 4 |
| dev-task-ops | `dev-task-ops.js` | 7 |
| notion-persona-cognition-ops | `notion-persona-cognition-ops.js` | 3 |
| **总计** | **19个模块** | **135** |
...
| AOAC-02 | 合并哨兵 | 🔶 half_ready | 2026-05-02 18:31 |
| AOAC-03 | 开发全链路Agent | ✅ completed | 2026-05-02 18:32 |
| AOAC-04 | 首页同步模块 | ✅ completed | 2026-05-02 23:46 |
| AOAC-05 | 首页主控Agent | ✅ completed | 2026-05-01 23:58 |
| AOAC-06 | Notion同步信号 | ⬜ warning | 2026-05-01 23:58 |
| AOAC-07 | 链路修复Agent | ✅ completed | 2026-05-02 00:30 |
| AOAC-08 | 修复监督Agent | ✅ completed | 2026-05-02 00:30 |

**最新链路报告**: AOAC-CHAIN-20260502-512
- PR #445: fix(ops-agent): dedupe tickets and add email kill switch + cooldown
- 变更: 0文件 (+0/-0)
- CI: ❌ failure
- 时间: 2026-05-02 18:32:01+08:00

**链路健康**: 🟡 warning · 完成周期: 21 · 修复次数: 21
...
*D63 · 2026-05-03 · 135个MCP工具 · 首页自动同步*
